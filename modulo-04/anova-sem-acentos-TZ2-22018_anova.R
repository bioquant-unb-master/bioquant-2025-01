...
ggplot(frutos2, aes(x = interaction(fat2, local), y = prod2, fill = interaction(fat2,local))) +
  geom_boxplot() +
  labs(title = "Produtividade por especie e local",
       x = "Grupo (espécie e local)",
       y = "Produtividade numero") +
  theme_minimal()
